<?php
// Permanent Sidebar navigation component with role-based access control
...
<div class="sidebar bg-light border-end vh-100 position-fixed d-none d-lg-block" style="width: 250px; z-index: 1000;">
  <div class="d-flex flex-column h-100">
    <!-- Sidebar Header -->
    <div class="sidebar-header p-3 border-bottom">
      <h5 class="mb-0">Lease Management</h5>
        ...
        <div class="nav-item mt-3">
          ...
          <div class="collapse" id="administration">
            <div class="nav flex-column ms-4">
              ...
              <div class="nav-item">
                <a class="nav-link" href="role_management.php">
    ...
    <div class="sidebar-footer p-3 border-top">
      <small class="text-muted">Lease Management System v1.0</small>
    </div>
  </div>
</div>
